...
class _CostsScreenState extends State<CostsScreen> {
  ...
  static const List<Map<String, dynamic>> _categoriasDespesa = [
    ...
    {'icon': Icons.local_fire_department, 'name': 'Gasolina'},
    {'icon': Icons.local_parking, 'name': 'Estacionamento'},
    {'icon': Icons.local_pharmacy, 'name': 'Remédios'},
    ...
    {'icon': Icons.local_convenience_store, 'name': 'Mercado'},
    {'icon': Icons.local_drink, 'name': 'Bebidas'},
    {'icon': Icons.local_hotel, 'name': 'Hospedagem'},
    ...
    {'icon': Icons.local_phone, 'name': 'Telefone'},
    {'icon': Icons.lock, 'name': 'Segurança'},
    {'icon': Icons.lock_clock, 'name': 'Segurança'},
