...
class _CostsScreenState extends State<CostsScreen>
  ...
  static const List<Map<String, dynamic>> _categoriasDespesa = [
    ...
    {'icon': Icons.local_gas_station, 'name': 'Combustível'},
    {'icon': Icons.lightbulb_outline, 'name': 'Energia'},
    ...
    {'icon': Icons.phone_android, 'name': 'Telefone Celular'},
    {'icon': Icons.local_pharmacy, 'name': 'Farmácia'},
    {'icon': Icons.home_repair_service, 'name': 'Reparos na Moradia'},
    {'icon': Icons.access_alarm_outlined, 'name': 'Alarme'},
    {'icon': Icons.admin_panel_settings, 'name': 'IPVA'},
    {'icon': Icons.assignment, 'name': 'IRPF'},
    ...
    {'icon': Icons.apartment, 'name': 'Condomínio'},
    {'icon': Icons.delete_outline, 'name': 'Taxa de Lixo'},
    {'icon': Icons.local_parking, 'name': 'Estacionamento'},
    {'icon': Icons.toll, 'name': 'Pedágios'},
    {'icon': Icons.build, 'name': 'Manutenção do Carro'},
    {'icon': Icons.local_car_wash, 'name': 'Lavagem de Carro'},
    {'icon': Icons.two_wheeler, 'name': 'Seguro de Moto'},
    {'icon': Icons.directions_bus, 'name': 'Transporte Público'},
    {'icon': Icons.local_taxi, 'name': 'Aplicativos de Transporte'},
    {'icon': Icons.health_and_safety, 'name': 'Plano de Saúde'},
    {'icon': Icons.local_hospital, 'name': 'Dentista'},
    {'icon': Icons.self_improvement, 'name': 'Terapias Alternativas'},
    {'icon': Icons.medication_liquid, 'name': 'Suplementos/Vitaminas'},
    {'icon': Icons.menu_book, 'name': 'Assinaturas de Revistas'},
    {'icon': Icons.videogame_asset, 'name': 'Serviços de Streaming de Jogos'},
    {'icon': Icons.delivery_dining, 'name': 'Serviços de Delivery'},
    {'icon': Icons.cleaning_services, 'name': 'Serviços de Faxina'},
    {'icon': Icons.grass, 'name': 'Jardinagem'},
    {'icon': Icons.face, 'name': 'Cuidados Pessoais'},
    {'icon': Icons.attach_money, 'name': 'Mesada/Pensão'},
    {'icon': Icons.volunteer_activism, 'name': 'Doações'},
    {'icon': Icons.palette, 'name': 'Hobbies'},
    {'icon': Icons.construction, 'name': 'Reparos e Manutenção Geral'},
    {'icon': Icons.savings, 'name': 'Investimentos'},
    {'icon': Icons.account_balance, 'name': 'Poupança para Emergências'},
