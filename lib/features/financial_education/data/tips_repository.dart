...
class TipsRepository {
  static final List<FinancialTip> tips = [
    // Dicas de Economia
    const FinancialTip(
      ...
      examples: [
        'Em uma geladeira de R\$ 3.000, você pode economizar R\$ 450 pagando à vista',
    ...
    const FinancialTip(
      ...
      examples: [
        'Com um salário de R\$ 2.000: R\$ 1.000 para essenciais, R\$ 600 para gastos pessoais, R\$ 400 para guardar',
      ],
    ),
    ...
    const FinancialTip(
      ...
      examples: [
        'Se seus gastos são R\$ 2.000/mês, sua reserva deve ser R\$ 12.000',
    ...
    const FinancialTip(
      ...
      description: 'Como usar o cartão de crédito de forma consciente e segura',
